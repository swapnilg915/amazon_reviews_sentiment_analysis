...
if __name__ == '__main__':
    ...
    obj.trainModel()
    query_lst = ['not a good service, good food, good ambience total waste of money','i am not satisfied with the conversation','its good but can be better','your chatbot is not good','you are such a dangerous']
